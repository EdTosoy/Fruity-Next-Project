        ...
        <main className="grid-container">
            <div className="col-start-2 col-end-3 flex flex-col md:flex-row justify-between items-center pt-20 pb-10">
                <div className="max-w-sm">
                    ...
                    <p className="mb-5 md:text-lg">We Beleive That Healthy Eating, Clean Air And, Gental Char Best Start To Genuinw Wellbeging</p>
                    <button className="rounded-md bg-purple-900 py-3 px-8 text-white">SHOP NOW</button>
                </div>
